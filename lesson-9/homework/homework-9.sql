...
select S.Name, En.CourseID from Students as S
Inner Join Enrollments as En on S.StudentID=En.StudentID
...
Select E.ManagerID,D.DepartmentName from Employees as E
...
Select E.Name, E.Salary, M.Salary from Employees as E
...
Select S.SaleID from Sales as S
...
Select E.Name, M.Name from Employees as E
 Join Employees as M on E.DepartmentID<>M.DepartmentID
...
Select P.Amount,P.OrderID,P.PaymentDate,P.PaymentID,P.PaymentMethod from Payments as P
Join Orders as O on P.OrderID=O.OrderID
Join Products as Pr on O.ProductID=Pr.ProductID
where P.Amount<>O.Quantity and P.Amount<>Pr.Price
...
Select distinct E2.Name from Employees as E1
